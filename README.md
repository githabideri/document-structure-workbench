...
DSW_CHAT_TIMEOUT=600  # compatibility/default provider request limit
DSW_CHAT_TOOL_REQUEST_TIMEOUT=300
DSW_CHAT_FINAL_REQUEST_TIMEOUT=600
DSW_CHAT_WALL_CLOCK_TIMEOUT=900  # total budget for model/tool orchestration
